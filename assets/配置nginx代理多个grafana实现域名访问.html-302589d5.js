...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7),c={href:"https://grafana.com/tutorials/run-grafana-behind-a-proxy/#1",target:"_blank",rel:"noopener noreferrer"};function _(u,m){const a=t("ExternalLinkIcon");return r(),s("div",null,[v,e("p",null,[n("详细参考"),e("a",c,[n("官网文档"),d(a)])])])}const g=i(o,[["render",_],["__file","配置nginx代理多个grafana实现域名访问.html.vue"]]);export{g as default};
